...
public class CategoryAdministrationSteps {
	...
	@Transactional
	public void the_category_should_have_an_id_greater_than(Long id) throws Throwable {
	...
	public void the_category_should_have_a_description_of(String description) throws Throwable {
		Category retrievedCategory = categoryBo.findById(category.getId());
		Assert.assertEquals(description, retrievedCategory.getDescription());
	}
	
	@Given("^a new category with a description of \"([^\"]*)\"$")
	public void a_new_category_with_a_description_of(String description) throws Throwable {
		category = new Category(description);
	...
	public void I_modify_the_category_to_have_a_description_of(String description) throws Throwable {
