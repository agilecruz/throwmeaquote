$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("com/throwmeaquote/category/CategoryAdministration.feature");
formatter.feature({
...
formatter.match({
  ...
  "location": "CategoryAdministrationSteps.I_save_a_new_category_with_a_description_of(String)"
});
formatter.result({
  "duration": 187657758,
  "status": "passed"
